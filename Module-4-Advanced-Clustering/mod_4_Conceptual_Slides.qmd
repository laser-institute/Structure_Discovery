---
title: "Module 4: Advanced Cluster Analysis"
subtitle: ""
format:
  revealjs: 
    slide-number: c/t
...
![](images/clipboard-1955655578.png)
...
![](images/clipboard-2360860354.png)
...
![](images/clipboard-419327094.png)
...
![](images/clipboard-2119975957.png)
...
## Example  ![](https://lh7-rt.googleusercontent.com/slidesz/AGV_vUcIYFSxu_fiDj3chpKxrb4u50Hr3zJzM-CPI9-f0gKCOMWR4v8oYEhUPZS66Obxr5m8a1c_FrwTBXlriMLCpuuD2tuBYCeMuoboznAPmUWs1Hqp0XxVUfo_o626zwjmYvD3U0XnHE-4T70qfVc8-NE=s2048?key=kEH-rc39vkHwJZiev6tvTx1p)  
...
##  Dendrogram  ![](images/clipboard-212659515.png)
...
::: notes
It just repeates that iteratively until all points are a cluster, or outliers. 
:::
